...
let
  eiros_zathura = config.eiros.system.default_applications.zathura;
in
{
  options.eiros.system.default_applications.zathura = {
    enable = lib.mkOption {
      default = true;
      description = "Install zathura document viewer.";
      example = lib.literalExpression ''
        {
          eiros.system.default_applications.zathura.enable = false;
        }
      '';
      type = lib.types.bool;
    };
    ...
    default_pdf_viewer.enable = lib.mkOption {
      ...
      example = lib.literalExpression ''
        {
          eiros.system.default_applications.zathura.default_pdf_viewer.enable = false;
        }
      '';
      type = lib.types.bool;
    };
    ...
    package = lib.mkOption {
      ...
      example = lib.literalExpression ''
        {
          eiros.system.default_applications.zathura.package = pkgs.zathura;
        }
      '';
