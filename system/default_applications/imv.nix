...
let
  eiros_imv = config.eiros.system.default_applications.imv;
in
{
  options.eiros.system.default_applications.imv = {
    enable = lib.mkOption {
      default = true;
      description = "Install imv image viewer.";
      example = lib.literalExpression ''
        {
          eiros.system.default_applications.imv.enable = false;
        }
      '';
      type = lib.types.bool;
    };
    ...
    default_image_viewer.enable = lib.mkOption {
      ...
      example = lib.literalExpression ''
        {
          eiros.system.default_applications.imv.default_image_viewer.enable = false;
        }
      '';
      type = lib.types.bool;
    };
    ...
    package = lib.mkOption {
      ...
      example = lib.literalExpression ''
        {
          eiros.system.default_applications.imv.package = pkgs.imv;
        }
      '';
