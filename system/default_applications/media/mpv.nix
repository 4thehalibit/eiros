...
let
  eiros_mpv = config.eiros.system.default_applications.media.mpv;
in
{
  options.eiros.system.default_applications.media.mpv = {
    enable = lib.mkOption {
      default = true;
      description = "Install mpv media player.";
      example = lib.literalExpression ''
        {
          eiros.system.default_applications.media.mpv.enable = false;
        }
      '';
      type = lib.types.bool;
    };
    ...
    default_media_player.enable = lib.mkOption {
      ...
      example = lib.literalExpression ''
        {
          eiros.system.default_applications.media.mpv.default_media_player.enable = false;
        }
      '';
      type = lib.types.bool;
    };
    ...
    package = lib.mkOption {
      ...
      example = lib.literalExpression ''
        {
          eiros.system.default_applications.media.mpv.package = pkgs.mpv-unwrapped;
        }
      '';
